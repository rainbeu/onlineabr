...
handles.Setup.Stimulus.Frequency      = 256;

% use either of these and set the other one to [] (empty brackets)
handles.Setup.Stimulus.ModulationDepth = [];  % in percent
handles.Setup.Stimulus.ModulationIndex = 0;  % in dB

handles.Setup.Stimulus.CarrierFrequency = 8000; 
...
handles.Setup.Stimulus.MaskerLevelOffsets    = []; % dB re masker level ("MaskerLevel")
handles.Setup.Stimulus.StimulusLevelOffsets  = []; % dB re stimulus level ("Level")
