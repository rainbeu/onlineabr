...
plot(handles.axLeftSig ,stSetup.t_ms,Data(:,7),'color',[0.8 0.8 0.8]);
hold(handles.axLeftSig,'on');
plot(handles.axLeftSig ,stSetup.t_ms,Data(:,5),'color','b');
hold(handles.axLeftSig,'off');
plot(handles.axRightSig,stSetup.t_ms,Data(:,8),'color',[0.8 0.8 0.8]);
hold(handles.axRightSig,'on');
plot(handles.axRightSig,stSetup.t_ms,Data(:,6),'color','r');
hold(handles.axRightSig,'off');
