handles.Setup.Stimulus.StimulusLevelOffsets  = [50:10:80]; % dB re stimulus level ("Level")
...
handles.Setup.Recording.FileName    = ['data/GEK0053_datafile_',handles.Setup.Stimulus.Type,...
