...
handles.Setup.Stimulus.Type           = 'CAP'; % 'click';  % 'tone'; % 'wave'; % 'CAP'; % 'transposedtone' 
...
handles.Setup.Stimulus.MaskerLevelOffsets    = [-inf 0 40 50 60];  % dB re masker level ("MaskerLevel")
handles.Setup.Stimulus.StimulusLevelOffsets  = [-inf 0 60];       % dB re stimulus level ("Level")
