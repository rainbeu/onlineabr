...
handles.Setup.Stimulus.StimulusLevelOffsets  = [-inf 45 65];   % dB re stimulus level ("Level")
...
%%
handles.Setup.Recording.ArtefactThr          = 2000;      % default 20 µV
...
handles.Setup.Stimulus.MaskerLevelOffsets    = [-inf 65];  % dB re masker level ("MaskerLevel")
